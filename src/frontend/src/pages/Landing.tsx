...
const HOW_IT_WORKS = [
  {
    step: "01",
    title: "Post a Job",
    desc: "Any institution posts repair & maintenance requirements with budget, deadline, and location details.",
    icon: ClipboardList,
  ...
  },
  {
    step: "02",
    title: "Providers Bid",
    desc: "Verified skilled service providers browse jobs and submit competitive bids with their approach and pricing.",
    icon: HardHat,
...
const FEATURES = [
  {
    ...
    desc: "All service providers are verified by platform admins before they can bid on jobs.",
  },
  {
    icon: Zap,
    title: "Fast Bidding",
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground text-base sm:text-lg mb-8 max-w-xl">
                A trusted marketplace for repair &amp; maintenance services.
                Post jobs, find verified skilled providers, and track work to
                completion — on-chain.
              </p>
      ...
      {/* Role cards — only show when logged out */}
      {!isAuthenticated && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="border border-border rounded-xl shadow-card overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Browse job postings, submit competitive bids, showcase your
                  skills and experience, and grow your professional reputation —
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Access the admin dashboard to verify service providers,
                  monitor jobs, manage users, and maintain platform integrity.
                </p>
                <ul className="space-y-2 mb-5">
                  {[
                    "Verify skilled service providers",
      ...
      >
        <div className="bg-primary rounded-2xl p-8 sm:p-12 text-center text-white">
          ...
          <p className="text-white/80 mb-6 max-w-md mx-auto">
            Join institutions and skilled service providers already on the
            platform.
          </p>
          <Button
            asChild
